...
export class DbService {
  ...
  private _createDatabase = (e:IDBVersionChangeEvent) => {
    ...
    const customerOS = db.createObjectStore('customers', {autoIncrement: true});
    const productsOS = db.createObjectStore('products', {autoIncrement: true});
  ...
  private _succesOpen = (e:Event)=>{
    ...
    const transaction = this.db.transaction(['customers','products'], 'readwrite');
